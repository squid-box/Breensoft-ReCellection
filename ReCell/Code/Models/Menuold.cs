...
namespace Recellection.Code.Models
{
    public class Menu : IModel
    {
        ...
        private void CreateConfirmationMenu()
        {
            ...
            //Init the regions!
            icons.Add(new GUIRegion(Recellection.windowHandle, new System.Windows.Rect(0, 0, confirmationButtonDimension.X, buttonDimension.Y)));
            ...
            icons.Add(new GUIRegion(Recellection.windowHandle, new System.Windows.Rect(confirmationButtonDimension.X, 0, confirmationButtonDimension.X, confirmationButtonDimension.Y)));
